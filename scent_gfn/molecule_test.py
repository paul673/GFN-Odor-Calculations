...
from pom_models.functions import fragance_propabilities_from_smiles_test
fragance_propabilities_from_smiles = lambda smiles: fragance_propabilities_from_smiles_test(smiles)
